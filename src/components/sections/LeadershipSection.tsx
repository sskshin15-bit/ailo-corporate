...
const leaders = [
  ...
  },
  {
    ...
    objectPosition: "36% 14%",
    scale: 1.22,
    transformOrigin: "36% 14%",
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {leaders.map((l) => (
            <Card key={l.seed} className="overflow-hidden p-0">
              <div className="relative h-60 w-full overflow-hidden border-b border-[var(--hairline-soft)] bg-paper sm:h-64">
                <div
                  className="absolute inset-0"
                  style={{
                    transform: l.scale !== 1 ? `scale(${l.scale})` : undefined,
